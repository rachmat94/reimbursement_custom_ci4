...
<head>
    ...
    margin: 0;
        ...
        .bg {
            ...
            background-image: linear-gradient(-60deg, #232323 50%, rgb(122, 49, 49) 50%);
            bottom: 0;
            left: -50%;
            opacity: .5;
            position: fixed;
            ...
            <div class="auth-box">
                <div class="row mb-3">
                    <div class="col-12 text-center">
                        <h5><i class="fas fa-exclamation-triangle"></i> Something Went Wrong</h5>
                    </div>
                </div>
                ...
                <?php endif; ?>
                <div class="row justify-content-center mb-3" style="min-height: 120px;max-height: 240px; overflow-y: auto;">
