        ...
        <div class="card elevation-2">
            ...
            <div class="card-body ">
                <div class="table-responsive">
                    <table class="table table-sm table-hover " style="width: 100%;" id="dtbl_jenis_berkas">
                        <thead>
                            <tr>
                                ...
                                <th>Code</th>
                                <th>Name</th>
                                <th>Mak.Ukuran Berkas</th>
                                <th style="width:160px;">Created at</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($dDtblJenisBerkas as $kRow  => $vRow) {
                            ?>
                                <tr>
                                    <?php
