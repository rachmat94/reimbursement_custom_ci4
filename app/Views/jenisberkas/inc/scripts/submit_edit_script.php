<script>
    {
        ...
        const formEditJenisBerkas = $("#edit_jenisberkas_form");
        formEditJenisBerkas.submit((e) => {
            e.preventDefault();
            setOnProgress(true);
            let data = new FormData(formEditJenisBerkas[0]);
            $.ajax({
                type: "post",
                url: formEditJenisBerkas.attr('action'),
                data: data,
                ...
                success: function(response) {
                    ...
                    if (response.code == "success") {
                        $("#edit_jenisberkas_modal").modal("hide");
                        setTimeout(() => {
