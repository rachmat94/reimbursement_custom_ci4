<script>
    {
        const formEditReimBerkas = $("#edit_reimberkas_form");
        formEditReimBerkas.submit((e) => {
            e.preventDefault();
            setOnProgress(true);
            let data = new FormData(formEditReimBerkas[0]);
            $.ajax({
                type: "post",
                url: formEditReimBerkas.attr('action'),
                data: data,
                ...
                success: function(response) {
                    ...
                    if (response.code == "success") {
                        $("#edit_reimberkas_modal").modal("hide");
                        setTimeout(() => {
