<script>
    {
        ...
        const formEditAppConfig = $(".appconfig_form");
        formEditAppConfig.submit((e) => {
            e.preventDefault();
            setOnProgress(true);
            let data = new FormData(formEditAppConfig[0]);
            $.ajax({
                type: "post",
                url: formEditAppConfig.attr('action'),
                data: data,
                ...
                success: function(response) {
                    ...
                    if (response.code == "success") {
                        $("#edit_appconfig_modal").modal("hide");
                        setTimeout(() => {
