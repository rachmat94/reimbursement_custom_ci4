...
class SubmissionWindowModel extends Model
{
    protected $table      = 'tb_submission_window';
    protected $primaryKey = 'sw_id';

    private $mainColumnOrder = ['sw_id', 'sw_id'];
    private $mainColumnSearch = ['sw_tahun'];
    private $mainOrder = ['sw_id' => 'desc'];
    ...
    public function generateCode()
    {
        ...
        $builder = $this->db->table("tb_submission_window");
        $builder->select("sw_code");
        $builder->where("sw_code", $code);
        $query = $builder->get();
